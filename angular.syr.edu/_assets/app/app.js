...
cafeApp.config( function($locationProvider,$routeProvider) {
    ...
    $routeProvider.when('/blog', {templateUrl: './_assets/partials/bloglist.html', controller: blogList});
    $routeProvider.when('/blog/:blogpath', {templateUrl: './_assets/partials/blog.html', controller: blogCtrl});
    $routeProvider.when('/contact', {templateUrl: './_assets/partials/contact.html', controller: contactUs});
